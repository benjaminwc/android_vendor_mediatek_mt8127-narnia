...
ifeq ($(strip $(MTK_OVERLAY_ENGINE_SUPPORT)), yes)
  ifeq ($(strip $(MTK_HWC_SUPPORT)), yes)
    $(call dep-err-offa-or-offb,MTK_OVERLAY_ENGINE_SUPPORT,MTK_HWC_SUPPORT)
  endif
  ifneq ($(strip $(MTK_HWC_VERSION)),1.3.0.8127)
    $(call dep-err-common, please turn off MTK_OVERLAY_ENGINE_SUPPORT or set MTK_HWC_VERSION as 1.3.0.8127)
  endif
endif
