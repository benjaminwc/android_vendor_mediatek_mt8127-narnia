        ...
        default:
    		{
    		    ...
    		    wpa_printf(MSG_DEBUG, "ret = %d, nl=%p",ret, drv->global->nl);
    		    return ret;
    		}
    }
...
void wpa_driver_nl80211_scan_loading_timeout(void *eloop_ctx, void *timeout_ctx)
{
	struct wpa_driver_nl80211_data *drv = eloop_ctx;

	wpa_printf(MSG_DEBUG, "[STAGE_SCAN] Scan loading timeout - update channel list");
