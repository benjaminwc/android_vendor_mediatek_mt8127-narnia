	...
	//long startTime = System.currentTimeMillis();
      ...
      //  long timeTaken=System.currentTimeMillis() - startTime;
        ...
        if (LOGGER.isActivated()) {
            LOGGER.debug(" Key before chyper"+ key );
        }
        if (c != null) {
...
*/
	...
	public void setAllImsProxyAddrForMobile(String addr ) {
	...
	public void setAllImsProxyPortForMobile(int port) {
...
/*	public void setAllImsProxyPortForWifi(int port) {
		if (instance != null) {
			
			writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_1, "" + port);
			writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_2, "" + port);
			writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_2, "" + port);
			writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_4, "" + port);
            writeParameter(RcsSettingsData.IMS_PROXY_ADDR_WIFI_5, "" + port);
	}
	}*/
	...
	public void setAllImsProxyAddrForWifi(String addr ) {
...
*/
   ...
   public long getProvisioningExpirationDate() {
    ...
    public void resetUserProfile() {
    	...
    	setAllImsProxyAddrForMobile("");
        setImsProxyAddrForWifi("",1);
    ...
    public boolean isUserProfileConfigured() {
    	// Check platform settings
         if (TextUtils.isEmpty(readParameter(RcsSettingsData.IMS_PROXY_ADDR_MOBILE_1))) {
             return false;
         }
...
/** M: Remove all users profile information @{ */
    public void removeAllUsersProfile() {
        ...
        setUserProfileImsPassword("");
        setAllImsProxyAddrForMobile("");
        setAllImsProxyPortForMobile(5060);
        setAllImsProxyAddrForWifi("");
        setAllImsProxyPortForWifi(5060);
        setUserProfileImsDisplayName("");
        setUserProfileImsPrivateId("");
        setXdmLogin("");
        setXdmPassword("");
