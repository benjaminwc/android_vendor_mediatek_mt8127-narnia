...
*/
            ...
            addParameter(db, table, RcsSettingsData.CAPABILITY_IP_VOICE_CALL,			RcsSettingsData.FALSE);
            addParameter(db, table, RcsSettingsData.CAPABILITY_IP_VIDEO_CALL,			RcsSettingsData.FALSE);
            ...
            addParameter(db, table, RcsSettingsData.CAPABILITY_GEOLOCATION_PUSH,		RcsSettingsData.FALSE);
