...
public class OtaPkgManagerActivity extends PkgManagerBaseActivity {
    ...
    private static final int CONFIRM_UPGRADE = 14;
    // M: add by mtk80800
    ...
    protected Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        case CONFIRM_UPGRADE:
                mAlertDialog = new AlertDialog.Builder(this)
                        .setMessage(
                                OtaPkgManagerActivity.this
                                        .getString(R.string.notify_backup))
    ...
    private void sendCheckOTAMessage() {
        if (mHandler != null) {
            ...
            case Util.OTAresult.ERROR_USERDATA_FREE_SPACE:
                ...
                // delete some file form sdcard
                break;
            case Util.OTAresult.CONFIRM_UPGRADE:
                
                mHandler.sendMessage(mHandler
                        .obtainMessage(SystemUpdateService.MSG_CONFIRM_UPGRADE));
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case SystemUpdateService.MSG_OTA_CLOSECLIENTUI:
                OtaPkgManagerActivity.this.finish();
                break;
            case SystemUpdateService.MSG_CONFIRM_UPGRADE:
                if (!mDownloadInfo.getNotifyStatus()) {
                    showDialog(CONFIRM_UPGRADE);
                    mDownloadInfo.setNotifyStatus(true);
                }
                break;
            default:
