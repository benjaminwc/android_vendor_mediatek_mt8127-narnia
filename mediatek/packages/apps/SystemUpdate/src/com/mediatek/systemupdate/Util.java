...
public final class Util {
    ...
    static class OTAresult {
        ...
        static final int CONFIRM_UPGRADE = 16;
    ...
    /**
    *
    * @return true if device is encrypt.
    */
   public static boolean isEncrypted() {
       boolean ret = false;
       ret = SystemProperties.get("ro.crypto.state").equals("encrypted");
       Xlog.i(TAG, "isEncrypted: " + ret);
       return ret;
   }
